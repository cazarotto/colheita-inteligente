    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 gap-3 md:gap-4">
        <KPICard
          ...
          icon={<TrendingUp className="h-4 w-4 text-primary-foreground" strokeWidth={2.5} />}
          variant="highlight"
        />
        <KPICard
          title="Recebido (mês)"
      ...
      <DataTable
        ...
        mobileCard={{
          title: (r) => r.descricao,
          subtitle: (r) => r.cliente,
          badge: (r) => <StatusBadge status={r.status} />,
          fields: [
            { label: "Valor", accessor: (r) => <span className="font-mono-data font-semibold text-financial-receber">{r.valor}</span> },
